...
public class Config implements InitializingBean {
    ...
    public BigInteger toSmallUnit(BigDecimal val,int decimals) {
    ...
    public BigInteger toSmallUnit(BigDecimal val) {
        return toSmallUnit(val,this.getDecimals());
    }
    ...
    public BigInteger toSmallUnit(String val,int decimals) {
        return toSmallUnit(new BigDecimal(val),decimals);
    }
