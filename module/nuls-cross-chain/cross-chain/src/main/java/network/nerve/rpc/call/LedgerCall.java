package network.nerve.rpc.call;
...
import static network.nerve.constant.NulsCrossChainConstant.INIT_CAPACITY_8;
import static network.nerve.constant.NulsCrossChainConstant.RPC_VERSION;
    ...
    public static void registerAsset(Chain chain, List<ChainInfo> chainInfoList) throws NulsException {
        try {
            ...
            try {
                ...
                ResponseMessageProcessor.requestOnly(ModuleE.LG.abbr, request);
            }catch (Exception e){
