...
//        accountService = SpringLiteContext.getBean(AccountService.class);
    ...
    public Response aliasTxCommit(Map<String, Object> params) throws Exception {
        Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, "ac_aliasTxCommit", params);
        return cmdResp;
    }
    ...
    public void getAliasByAddressTest() throws Exception {
        ...
        params.put(Constants.CHAIN_ID, chainId);
        params.put("address", address);
        Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, "ac_getAliasByAddress", params);
        assertNotNull(cmdResp);
    ...
    public void isAliasUsableTest() throws Exception {
        ...
        Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, "ac_isAliasUsable", params);
        assertNotNull(cmdResp);
    ...
    public void rollbackAliasTest() throws Exception {
        ...
        Response rollbackCmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, "ac_aliasTxRollback", rollbackParams);
