...
public class AccountCmdTest {
    ...
    public SimpleAccountDTO getAccountByAddress(int chainId, String address) throws Exception {
        ...
        Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, "ac_getAccountByAddress", params);
...
*/
    ...
    public void getAccountByAddressTest() throws Exception {
        ...
        SimpleAccountDTO accountDto = getAccountByAddress(chainId, "tNULSeBaMoGr2RkLZPfJeS5dFzZeNj1oXmaYNe");
        System.out.println(accountDto.getPubkeyHex());
        //assertEquals(accountList.get(0), accountDto.getAddress());
    }

    @Test
    public void getAccountListTest() throws Exception {
        Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, "ac_getAccountList", null);
    ...
    public void getAddressListTest() throws Exception {
        ...
        Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, "ac_getAddressList", params);
        ...
        cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, "ac_getAddressList", params);
    ...
    public void getAllPrivateKeyTest() {
        try {
            ...
            params.put("password", password);
            Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, "ac_getAllPriKey", params);
            if (AccountConstant.SUCCESS_CODE.equals(cmdResp.getResponseStatus())) {
                ...
                cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, "ac_getAllPriKey", params);
    ...
    public void setRemarkTest() {
        try {
            ...
            Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, "ac_setRemark", params);
            assertEquals(AccountConstant.SUCCESS_CODE, cmdResp.getResponseStatus());
        } catch (NulsRuntimeException e) {
            e.printStackTrace();
        } catch (Exception e) {
...
//            assertEquals(accountList.get(0), address);
    ...
    public void setPasswordTest() {
        try {
            ...
            params.put("address", address);
            params.put("password", password);
            Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, "ac_setPassword", params);
...
//            assertEquals(AccountErrorCode.PASSWORD_IS_WRONG.getCode(), result.get("code"));
    ...
    public void validationPasswordTest() {
        try {
            ...
            params.put("address", address);
            params.put("password", password);
            Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, "ac_validationPassword", params);
...
//            }
            ...
            Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, "ac_signDigest", params);
