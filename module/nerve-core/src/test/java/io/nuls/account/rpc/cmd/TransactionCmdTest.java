...
//                "00d9a2384a3bc9fca252c8e2c8728efcb98e007b5290d7f01a008731669e433043",password);
    ...
    public void addGenesisAsset(String address) throws Exception {
        ...
        Response response = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.LG.abbr, "bathValidateBegin", params);
        ...
        response = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.LG.abbr, "validateCoinData", params);
        Log.info("response {}", response);
        ...
        params.remove("txHex");
        response = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.LG.abbr, "commitTx", params);
        Log.info("response {}", response);
    }
...
//        System.out.println(balance.longValue());
    ...
    public void transfer() throws Exception {
        ...
        Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, "ac_transfer", JSONUtils.json2map(JSONUtils.obj2json(transferDto)));
...
//        assertNotNull(afterSetALias);
        ...
        Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, "ac_transfer", params);
...
//            Response dpResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.CS.abbr, "cs_depositToAgent", dpTxMap);
...
//            withdraw();
    ...
    private Map<String, Object> createMultiSignTransfer() throws Exception {
        ...
        params.put("remark", "EdwardTest");
        Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, "ac_createMultiSignTransfer", params);
