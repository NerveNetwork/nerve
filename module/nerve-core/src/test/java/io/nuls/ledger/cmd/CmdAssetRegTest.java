...
public class CmdAssetRegTest {
    ...
    public void getAssetRegInfoTest() throws Exception {
        ...
        Response response = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.LG.abbr, "getAssetRegInfo", params);
    ...
    public void chainAssetTxRegTest() throws Exception {
        ...
        Response response = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.LG.abbr, "chainAssetTxReg", params);
        Log.debug("response {}", JSONUtils.obj2json(response));
    }
    @Test
    ...
    public void chainAssetTxRegTest2() throws Exception {
        ...
        params.put("assetOwnerAddress","TNVTdN9iJVX42PxxzvhnkC7vFmTuoPnRAgtyA");
        params.put("password","nuls123456");
        response = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.LG.abbr, "chainAssetTxReg", params);
        Log.debug("response {}", JSONUtils.obj2json(response));
    }
    ...
    public void getAssetRegInfoByHashTest() throws Exception {
        ...
        Response response = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.LG.abbr, "getAssetRegInfoByHash", params);
        Log.debug("response {}", JSONUtils.obj2json(response));
    }
    @Test
    public void getAssetContractAddressTest() throws Exception {
        ...
        Response response = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.LG.abbr, "getAssetContractAddress", params);
        Log.debug("response {}", JSONUtils.obj2json(response));
    }
    @Test
    public void getAssetRegInfoByAssetIdTest() throws Exception {
        ...
        params.put("chainId",1);
        params.put("assetId",2);
        Response response = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.LG.abbr, "getAssetRegInfoByAssetId", params);
        Log.debug("response {}", JSONUtils.obj2json(response));
    }
    @Test
    public void getAssetContractAssetIdTest() throws Exception {
        ...
        Response response = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.LG.abbr, "getAssetContractAssetId", params);
        Log.debug("response {}", JSONUtils.obj2json(response));
    }
    ...
    public void getAssetInfoTest() throws Exception {
        ...
        Map data = (Map) NerveCoreRpcCall.requestAndResponse(ModuleE.LG.abbr, "lg_get_all_asset", params);
