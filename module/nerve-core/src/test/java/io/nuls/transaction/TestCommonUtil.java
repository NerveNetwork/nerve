...
//    public static String SOURCE_ADDRESS = "tNULSeBaMth1hiT6khgSjDqazSEpfNxM5D1Mqs";
    ...
    public static List<String> createAccounts(int num) throws Exception {
        ...
        for (int i = 0; i < num / 100; i++) {
            ...
            Response response = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, "ac_createAccount", params);
    ...
    public static List<String> getAccountList() throws Exception {
        ...
        Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, "ac_getAccountList", params);
    ...
    public static Response transfer(String from, String to, String s) throws Exception {
        ...
        return NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, "ac_transfer", transferMap);
    }
    ...
    public static boolean queryTx(String hash, boolean confirmed) throws Exception {
        ...
        Response response = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.TX.abbr, cmd, params);
        assertTrue(response.isSuccess());
        Map map = (Map) response.getResponseData();
    ...
    public static String createContract(String account, String pwd, String code, Object[] args) throws Exception {
        ...
        Response response = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.SC.abbr, "sc_create", params);
        assertTrue(response.isSuccess());
        Map map = (Map) response.getResponseData();
...
//        return tx.get("contractAddress").toString();
    ...
    public static String callContract(String account, String pwd, BigInteger value, String address, String methodName, Object[] args) throws Exception {
        ...
        params.put("methodDesc", null);
        if (args != null) {
            params.put("args", args);
        }
        params.put("remark", "this is a test");
        Response response = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.SC.abbr, "sc_call", params);
        assertTrue(response.isSuccess());
        Map map = (Map) response.getResponseData();
        Map tx = (Map) map.get("sc_call");
        return tx.get("txHash").toString();
    }
    ...
    public static String deleteContract(String account, String pwd, String address) throws Exception {
        ...
        params.put("contractAddress", address);
        params.put("remark", "this is a test");
        Response response = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.SC.abbr, "sc_delete", params);
        assertTrue(response.isSuccess());
        Map map = (Map) response.getResponseData();
        Map tx = (Map) map.get("sc_delete");
        return tx.get("txHash").toString();
    }
    ...
    public static void removeAccount(String address, String password) throws Exception {
        ...
        params.put("password", password);
        Response response = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, "ac_removeAccount", params);
        assertTrue(response.isSuccess());
    ...
    public static boolean setAlias(Chain chain, String address) throws Exception {
        ...
        LOG.info(address + "-----balance:{}", balance);
        {
            ...
            Response response = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, "ac_setAlias", params);
