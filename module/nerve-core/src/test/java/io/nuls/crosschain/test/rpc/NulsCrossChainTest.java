package io.nuls.crosschain.test.rpc;
...
public class NulsCrossChainTest {
    ...
    private String createCtx(){
        try{
            ...
            //Calling interfaces
            Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.CC.abbr, "createCrossTx", paramMap);
    ...
    public static void main(String[] args) throws NulsException, IOException {
        ...
        NerveCoreConfig crossChainConfig = new NerveCoreConfig();
