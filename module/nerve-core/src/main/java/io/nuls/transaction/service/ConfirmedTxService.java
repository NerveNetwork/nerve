...
public interface ConfirmedTxService {
     ...
     */
    boolean saveGengsisTxList(Chain chain, List<String> txStrList, String blockHeader, int syncStatus) throws NulsException;
     ...
     * @param txStrList
     * @param blockHeader
     * @param syncStatus 0:Synchronization status, 1:normal operation
     * @return
     */
    ...
    /**
     * Obtain complete transactions for blocks Confirmed, unconfirmed, all checked
