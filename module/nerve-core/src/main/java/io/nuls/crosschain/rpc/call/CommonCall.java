...
public class CommonCall {
    ...
    public static Object request(String moduleCode, String cmd, Map params, Long timeout) throws NulsException {
        try {
            ...
            Response cmdResp;
            if(null == timeout) {
                cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(moduleCode, cmd, params);
            }else{
                cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(moduleCode, cmd, params, timeout);
            }
