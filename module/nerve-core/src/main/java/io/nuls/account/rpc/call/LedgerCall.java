...
public class LedgerCall {
    ...
    public static HashMap getBalanceNonce(Chain chain, int assetChainId, int assetId, String address) {
        try {
            ...
            Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.LG.abbr, "getBalanceNonce", params);
    ...
    public static BigInteger getBalance(Chain chain, int assetChainId, int assetId, String address) {
        try {
            ...
            params.put("assetChainId", assetChainId);
            params.put("assetId", assetId);
            Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.LG.abbr, "getBalance", params);
            if (!cmdResp.isSuccess()) {
