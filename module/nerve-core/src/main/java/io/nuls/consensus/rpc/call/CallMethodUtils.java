...
public class CallMethodUtils {
    ...
    public static String getPublicKey(int chainId, String address, String password) throws NulsException {
        try {
            ...
            Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, CALL_AC_GET_PUBLIC_BY_ADDRESS, callParams);
    ...
    public static HashMap getPrivateKey(int chainId, String address, String password) throws NulsException {
        try {
            ...
            callParams.put(PARAM_ADDRESS, address);
            callParams.put(PARAM_PASSWORD, password);
            Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, CALL_AC_GET_PRIKEY_BY_ADDRESS, callParams);
            if (!cmdResp.isSuccess()) {
                throw new NulsException(ConsensusErrorCode.ACCOUNT_VALID_ERROR);
            }
    ...
    public static boolean accountValid(int chainId, String address, String password) throws NulsException {
        try {
            ...
            callParams.put(PARAM_ADDRESS, address);
            callParams.put(PARAM_PASSWORD, password);
            Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, CALL_AC_ACCOUNT_VALID, callParams);
            if (!cmdResp.isSuccess()) {
                throw new NulsException(ConsensusErrorCode.ACCOUNT_VALID_ERROR);
            }
    ...
    public static MultiSigAccount getMultiSignAccount(int chainId, String address) throws NulsException {
        try {
            ...
            callParams.put(PARAM_ADDRESS, address);
            Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, CALL_AC_GET_MULTI_SIGN_ACCOUNT, callParams);
            if (!cmdResp.isSuccess()) {
                throw new NulsException(ConsensusErrorCode.ACCOUNT_VALID_ERROR);
            }
    ...
    public static void transactionSignature(int chainId, String address, String password, String priKey, Transaction tx) throws NulsException {
        try {
            ...
            if (!StringUtils.isBlank(priKey)) {
                ...
                Response signResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, CALL_AC_GET_SIGN_DIGEST, callParams);
    ...
    public static void blockSignature(Chain chain, String address, BlockHeader header) throws NulsException {
        try {
            ...
            Response signResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, CALL_AC_SIGN_BLOCK_DIGEST_NEW, callParams);
            if (!signResp.isSuccess()) {
                throw new NulsException(ConsensusErrorCode.TX_SIGNTURE_ERROR);
            }
    ...
    public static byte[] signature(Chain chain, String address, byte[] data, Map<String, Object> extendMap) throws NulsException {
        try {
            ...
            callParams.put(PARAM_EXTEND, extendMap);
            Response signResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, CALL_AC_GET_SIGN_DIGEST_NEW, callParams);
            if (!signResp.isSuccess()) {
                throw new NulsException(ConsensusErrorCode.TX_SIGNTURE_ERROR);
            }
    ...
    public static Map<String, Object> getBalanceAndNonce(Chain chain, String address, int assetChainId, int assetId) throws NulsException {
        ...
        try {
            Response callResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.LG.abbr, CALL_LG_GET_BALANCE_NONCE, params);
    ...
    public static Map<String, Object> getBalance(Chain chain, String address, int assetChainId, int assetId) throws NulsException {
        ...
        params.put(PARAM_ASSET_ID, assetId);
        try {
            Response callResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.LG.abbr, CALL_LG_GET_BALANCE, params);
            if (!callResp.isSuccess()) {
                return null;
            }
...
//            chain.getLogger().info("packEndTime:{},currentTime:{},打包时间为：{}",packEndTime,currentTime,surplusTime);
    ...
    public static Transaction getTransaction(Chain chain, String txHash) {
        try {
            ...
            Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.TX.abbr, CALL_TX_CONFIRMED_TX, params);
            if (!cmdResp.isSuccess()) {
    ...
    public static void sendTx(Chain chain, String tx) throws NulsException {
        ...
        try {
            cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.TX.abbr, CALL_TX_NEW_TX, params);
        } catch (Exception e) {
            chain.getLogger().error(e);
            throw new NulsException(ConsensusErrorCode.INTERFACE_CALL_FAILED);
        }
    ...
    public static void sendState(Chain chain, boolean packing) {
        try {
            ...
            Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.TX.abbr, CALL_TX_CONSENSUS_STATE, params);
            if (!cmdResp.isSuccess()) {
    ...
    public static Response verify(int chainId, List<Transaction> transactions, BlockHeader header, BlockHeader lastHeader, NulsLogger logger) {
        try {
            ...
            return NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.TX.abbr, CALL_TX_BATCH_VERIFY, params, 10 * 60 * 1000);
        } catch (Exception e) {
            logger.error("", e);
            return null;
        }
    ...
    public static List<byte[]> getEncryptedAddressList(Chain chain) {
        ...
        try {
            ...
            Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, CALL_AC_GET_ENCRYPTED_ADDRESS_LIST, params);
    ...
    public static String getAlias(Chain chain, String address) {
        ...
        try {
            ...
            params.put(Constants.CHAIN_ID, chain.getConfig().getChainId());
            params.put(PARAM_ADDRESS, address);
            Response cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, CALL_AC_GET_ALIAS_BY_ADDRESS, params);
    ...
    public static void loadBlockHeader(Chain chain) throws Exception {
        ...
        Response response = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.BL.abbr, CALL_BL_GET_LATEST_ROUND_BLOCK_HEADERS, params);
        ...
        while (!response.isSuccess() && blockHeaderHexs.size() == 0) {
            response = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.BL.abbr, CALL_BL_GET_LATEST_ROUND_BLOCK_HEADERS, params);
            if (response.isSuccess()) {
                responseData = (Map<String, Object>) response.getResponseData();
                Map result = (Map) responseData.get(CALL_BL_GET_LATEST_ROUND_BLOCK_HEADERS);
                blockHeaderHexs = (List<String>) result.get(PARAM_RESULT_VALUE);
    ...
    public static void getRoundBlockHeaders(Chain chain, long roundCount, long startHeight) throws Exception {
        ...
        Response response = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.BL.abbr, CALL_BL_GET_ROUND_BLOCK_HEADERS, params);
        Map<String, Object> responseData;
        List<String> blockHeaderHexs = new ArrayList<>();
        if (response.isSuccess()) {
            responseData = (Map<String, Object>) response.getResponseData();
        ...
        while (!response.isSuccess() && blockHeaderHexs.size() == 0 && tryCount < ConsensusConstant.RPC_CALL_TRY_COUNT) {
            response = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.BL.abbr, CALL_BL_GET_ROUND_BLOCK_HEADERS, params);
            if (response.isSuccess()) {
                responseData = (Map<String, Object>) response.getResponseData();
                Map result = (Map) responseData.get(CALL_BL_GET_ROUND_BLOCK_HEADERS);
                blockHeaderHexs = (List<String>) result.get(PARAM_RESULT_VALUE);
    ...
    private static boolean noticeByzantineResult(Chain chain, Map params) {
        ...
        try {
            Response callResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.BL.abbr, CALL_BL_PUT_BZFT_FLAG, params);
    ...
    public static void noticeGetBlock(Chain chain, long height, String nodeId, NulsHash firstHash, NulsHash secondHash) {
        ...
        try {
            ...
            NerveCoreResponseMessageProcessor.requestOnly(ModuleE.BL.abbr, request);
        } catch (Exception e) {
            chain.getLogger().error(e);
        }
    }
    ...
    public static Map getVersion(int chainId) throws NulsException {
        ...
        params.put(Constants.CHAIN_ID, chainId);
        try {
            Response callResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.PU.abbr, CALL_PU_GET_VERSION, params);
            if (!callResp.isSuccess()) {
                return null;
            }
     ...
     */
    @SuppressWarnings("unchecked")
    public static double getRealAmount(int chainId, String key, String date) throws NulsException {
        Map<String, Object> params = new HashMap(4);
        params.put(Constants.CHAIN_ID, chainId);
        try {
            params.put(PARAM_KEY, key);
            params.put(PARAM_DATE, date);
            Response callResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.QU.abbr, CALL_QU_FINAL_QUOTATION, params);
            if (!callResp.isSuccess()) {
                return 0;
            }
            ...
            return (Double) result.get(PARAM_PRICE);
        } catch (Exception e) {
            throw new NulsException(e);
        }
    }
    ...
    public static int getAssetPrecision(int chainId, int assetChainId, int assetId) throws NulsException {
        ...
        try {
            cmdResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.LG.abbr, "lg_get_asset", params);
        } catch (Exception e) {
    ...
    public static byte[] prikeyDecrpyt(Chain chain, String address, String data, Map<String, String> extendMap) throws NulsException {
        try {
            ...
            callParams.put(PARAM_EXTEND, extendMap);
            Response signResp = NerveCoreResponseMessageProcessor.requestAndResponse(ModuleE.AC.abbr, CALL_AC_ECIES_DECRYPT, callParams);
            if (!signResp.isSuccess()) {
                throw new NulsException(ConsensusErrorCode.TX_SIGNTURE_ERROR);
            }
