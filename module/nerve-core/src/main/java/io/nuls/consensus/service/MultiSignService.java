...
public interface MultiSignService {
    ...
    /**
     * Additional Guarantee for Multiple Account Nodes
     * */
    Result appendMultiAgentDeposit(Map<String,Object> params);

    /**
     * Multiple account node withdrawal margin
     * */
    Result reduceMultiAgentDeposit(Map<String,Object> params);
