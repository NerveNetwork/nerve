...
import io.nuls.converter.heterogeneouschain.eth.base.Base;
...
public class ETHWalletApiTest extends Base {
    ...
    public void getTxJson() throws Exception {
        String txHash = "0x952c4814b0a7b06ec89738a31b26e02d37d7b23d3cd2f52ee01be4cdbb9fd7ce";
        Transaction tx = ethWalletApi.getTransactionByHash(txHash);
...

    ...
    @Test
    public void txInputDecoderTest() {
        // 46b4c37e
        String input = "";
        List<Object> typeList = EthUtil.parseInput(input, EthConstant.INPUT_WITHDRAW);
        System.out.println(typeList.size());

        String changeInput = "";
        List<Object> typeListOfChange = EthUtil.parseInput(changeInput, EthConstant.INPUT_CHANGE);
        System.out.println(typeListOfChange.size());
    }
    ...
    public void ethEstimateGasTest() throws Exception {
        ...
        Function function = new Function(
                "createOrSignManagerChange",
                List.of(new Utf8String("bnmbnm"), new DynamicArray(Address.class, List.of(
                                                                            new Address("0xc11D9943805e56b630A401D4bd9A29550353EFa1"),
                                                                            new Address("0x11eFE2A9CF96175AB241e4A88A6b79C4f1c70389"))),
                        new DynamicArray(Address.class, List.of())),
                List.of(new TypeReference<Type>() {})
        );
        ...
        if(estimateGas.getResult() != null) {
            System.out.println(JSONUtils.obj2PrettyJson(estimateGas));
        } else {
