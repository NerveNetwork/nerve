...
public interface ConverterErrorCode extends CommonCodeConstanst {
    ...
    ErrorCode PROPOSAL_TYPE_INVALID = ErrorCode.init(ModuleE.CV.getPrefix() + "_0005");
    ...
    ErrorCode WITHDRAWAL_SUBSIDY_FEE_ADDRESS_ERROR = ErrorCode.init(ModuleE.CV.getPrefix() + "_0038");
    ErrorCode WITHDRAWAL_INSUFFICIENT_SUBSIDY_FEE = ErrorCode.init(ModuleE.CV.getPrefix() + "_0039");
    ...
    ErrorCode DISTRIBUTION_ADDRESS_LIST_EMPTY = ErrorCode.init(ModuleE.CV.getPrefix() + "_0042");
    ...
    ErrorCode BLOCK_TX_DUPLICATION = ErrorCode.init(ModuleE.CV.getPrefix() + "_0048");
