...
//        importPriKey("27dbdcd1f2d6166001e5a722afbbb86a845ef590433ab4fcd13b9a433af6e66e", password);//28 tNULSeBaMoNnKitV28JeuUdBaPSR6n1xHfKLj2
        ...
        importPriKey("50a0631304ba75b1519c96169a0250795d985832763b06862167aa6bbcd6171f", password);// 出块
    ...
    public void allToken() {
        try {
            // 账户已存在则覆盖 If the account exists, it covers.
            Map<String, Object> params = new HashMap<>();
            Response cmdResp = ResponseMessageProcessor.requestAndResponse(ModuleE.CV.abbr, "cv_get_all_heterogeneous_chain_asset_list", params);
            HashMap result = (HashMap) ((HashMap) cmdResp.getResponseData()).get("cv_get_all_heterogeneous_chain_asset_list");
            Log.debug(JSONUtils.obj2PrettyJson(result.get("list")));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void getBalance() throws Exception {
        ...
        NonceBalance balance = LedgerCall.getBalanceNonce(chain, heterogeneousChainId, heterogeneousAssetId, address30);
        System.out.println("ETH:" + balance.getAvailable());
        NonceBalance balance3 = LedgerCall.getBalanceNonce(chain, heterogeneousChainId, 2, address30);
    ...
    public void withdrawalERC20() throws Exception {
        ...
        params.put("heterogeneousChainId", heterogeneousChainId);
        params.put("heterogeneousAssetId", 2);
        params.put("heterogeneousAddress", "0xfa27c84eC062b2fF89EB297C24aaEd366079c684");
    ...
    @Test
    public void getVirtualBankDirector() {
