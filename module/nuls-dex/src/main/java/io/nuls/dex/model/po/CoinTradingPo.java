...
public class CoinTradingPo extends BaseNulsData {
    ...
    public CoinTradingPo copy() {
        ...
        po.minTradingAmount = new BigInteger(this.minTradingAmount.toString());
        return po;
    }
    ...
    public CoinTradingPo(NulsHash hash, CoinTrading trading) {
        ...
        this.minTradingAmount = trading.getMinTradingAmount();
    }
    ...
    public void parse(NulsByteBuffer byteBuffer) throws NulsException {
        ...
        this.minTradingAmount = byteBuffer.readBigInteger();
    }
    ...
    public String toString() {
        return "coinHash:" + hash.toHex() + ", baseChainId:" + baseAssetChainId + ", baseAssetId:" + baseAssetId + ", baseDecimal:" + baseDecimal + ",scaleBaseDecimal:" + scaleBaseDecimal +
                ",quoteChainId: " + quoteAssetChainId + ", quoteAssetId: " + quoteAssetId + ", quoteDecimal:" + quoteDecimal + ", scaleQuoteDecimal" + scaleQuoteDecimal + ",minTradingAmount:" + minTradingAmount;
    }
