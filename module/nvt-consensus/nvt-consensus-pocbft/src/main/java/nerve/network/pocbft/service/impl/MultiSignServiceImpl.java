...
public class MultiSignServiceImpl implements MultiSignService {
    ...
    public Result multiWithdraw(Map<String, Object> params) {
        ...
        try {
            ...
            int txSignSize = multiSigAccount.getM() * P2PHKSignature.SERIALIZE_LENGTH;
            CoinData coinData = coinDataManager.getWithdrawCoinData(cancelDeposit.getAddress(), chain, deposit.getDeposit(), 0, cancelDepositTransaction.size() + txSignSize, chain.getChainId(), chain.getAssetId());
