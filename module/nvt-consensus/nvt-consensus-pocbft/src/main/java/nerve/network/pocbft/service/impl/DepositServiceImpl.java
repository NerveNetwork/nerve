...
import nerve.network.pocbft.model.dto.input.CreateDepositDTO;
import nerve.network.pocbft.model.dto.input.SearchDepositDTO;
import nerve.network.pocbft.model.dto.input.WithdrawDTO;
import nerve.network.pocbft.model.dto.output.DepositDTO;
import nerve.network.pocbft.rpc.call.CallMethodUtils;
import nerve.network.pocbft.service.DepositService;
...
import nerve.network.pocbft.utils.manager.CoinDataManager;
    ...
    public Result withdraw(Map<String, Object> params) {
        ...
        try {
            ...
            if(deposit.getDepositType() == DepositType.REGULAR.getCode()){
                ...
                long periodicTime = deposit.getTime() + depositTimeType.getTime();
