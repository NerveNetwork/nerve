...
public class TxRelationInfo {
    ...
    public TxRelationInfo(TransactionInfo tx, DepositInfo depositInfo, BigInteger balance) {
        this.address = depositInfo.getAddress();
        this.txHash = tx.getHash();
        this.type = tx.getType();
        this.createTime = tx.getCreateTime();
        this.height = tx.getHeight();
        this.fee = tx.getFee();
        this.chainId = depositInfo.getAssetChainId();
        this.assetId = depositInfo.getAssetId();
        this.symbol = depositInfo.getSymbol();
        this.values = depositInfo.getAmount();
        this.transferType = TRANSFER_FROM_TYPE;
        this.balance = balance;
    }
