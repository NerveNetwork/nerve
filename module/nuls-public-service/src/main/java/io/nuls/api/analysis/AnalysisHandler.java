...
//        Log.warn("未处理交易类型：{}",tx.getType());
    ...
    private static ConverterTxInfo toConverterTxInfo(Transaction tx) throws NulsException {
