...
public class ApiCache {
    ...
    private BlockTimeInfo blockTimeInfo;
    ...
    public BlockTimeInfo getBlockTimeInfo() {
        return blockTimeInfo;
    }

    public void setBlockTimeInfo(BlockTimeInfo blockTimeInfo) {
        this.blockTimeInfo = blockTimeInfo;
    }

    public void setNrc20InfoList(List<Nrc20Info> nrc20InfoList) {
        this.nrc20InfoList = nrc20InfoList;
    }
}
