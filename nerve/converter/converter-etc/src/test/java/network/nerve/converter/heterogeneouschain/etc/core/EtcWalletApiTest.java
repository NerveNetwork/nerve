package network.nerve.converter.heterogeneouschain.etc.core;
...
import network.nerve.converter.heterogeneouschain.etc.base.Base;
...
public class EtcWalletApiTest extends Base {
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_ETC;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_ETC;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_ETC_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void before() {
        try {
            String path = new File(EtcWalletApiTest.class.getClassLoader().getResource("").getFile()).getParentFile().getParentFile().getParentFile().getParentFile().getParentFile().getPath();
    ...
    public void getBalance() throws Exception {
        setLocalTest();
        setAccount_EFa1();
        erc20BalancePrint("NVT", from, NVT_ETC_MINTER, 8);
        erc20BalancePrint("USDT", from, USDT_ETC, 6);
