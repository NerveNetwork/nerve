package network.nerve.converter.heterogeneouschain.bch.core;
...
import network.nerve.converter.heterogeneouschain.bch.base.Base;
...
public class BchWalletApiTest extends Base {
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_BCH;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_BCH;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_BCH_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void depositERC20ByCrossOut() throws Exception {
        ...
        String sendAmount = "105.124";// 1.123456, 1234.123456789123456789
    ...
    public void getBalance() throws Exception {
        setLocalTest();
        setAccount_EFa1();
        erc20BalancePrint("NVT", from, NVT_BCH_MINTER, 8);
        erc20BalancePrint("USDT", from, USDT_BCH, 6);
    ...
    public void newParseWithdrawTxReceiptSinceProtocol21Test() throws Exception {
        ...
        list.add("0xa3a698f263295026ce480c67adda70f301ef1fd8e59d0f462327a0e14ed06c6d");
