package network.nerve.converter.heterogeneouschain.zeta;
...
public class ZetaWalletApiTest extends Base {

    String testEthRpcAddress = "https://zetachain-athens-evm.blockpi.network/v1/rpc/public";
    int testChainId = 7001;
    String mainEthRpcAddress = "https://api.mainnet.zetachain.com/evm";
    int mainChainId = 7000;
    @Override
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_ZETA;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_ZETA;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_ZETA_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void before() {
        try {
            String path = new File(ZetaWalletApiTest.class.getClassLoader().getResource("").getFile()).getParentFile().getParentFile().getParentFile().getParentFile().getParentFile().getPath();
