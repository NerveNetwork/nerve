package network.nerve.converter.heterogeneouschain.mode;
...
public class ModeWalletApiTest extends Base {

    String testEthRpcAddress = "https://sepolia.mode.network/";
    int testChainId = 919;
    String mainEthRpcAddress = "https://mainnet.mode.network/";
    int mainChainId = 34443;
    @Override
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_MODE;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_MODE;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_MODE_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void before() {
        try {
            String path = new File(ModeWalletApiTest.class.getClassLoader().getResource("").getFile()).getParentFile().getParentFile().getParentFile().getParentFile().getParentFile().getPath();
