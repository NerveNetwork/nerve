package network.nerve.converter.heterogeneouschain.merlin;
...
public class MerlinWalletApiTest extends Base {

    String testEthRpcAddress = "https://testnet-rpc.merlinchain.io";
    int testChainId = 686868;
    String mainEthRpcAddress = "https://rpc.merlinchain.io";
    int mainChainId = 4200;
    @Override
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_MERLIN;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_MERLIN;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_MERLIN_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void before() {
        try {
            String path = new File(MerlinWalletApiTest.class.getClassLoader().getResource("").getFile()).getParentFile().getParentFile().getParentFile().getParentFile().getParentFile().getPath();
