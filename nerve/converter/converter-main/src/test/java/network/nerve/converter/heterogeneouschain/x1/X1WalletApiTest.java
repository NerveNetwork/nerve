package network.nerve.converter.heterogeneouschain.x1;
...
public class X1WalletApiTest extends Base {
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_X1;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_X1;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_X1_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void before() {
        try {
            String path = new File(X1WalletApiTest.class.getClassLoader().getResource("").getFile()).getParentFile().getParentFile().getParentFile().getParentFile().getParentFile().getPath();
    ...
    public void getBalance() throws Exception {
        setLocalTest();
        setAccount_EFa1();
        erc20BalancePrint("NVT", from, NVT_X1_MINTER, 8);
        erc20BalancePrint("USDT", from, USDT_X1, 6);
