...
public class Protocol27Test {
    ...
    private Map<Integer, HtgContext> contextMap() {
        ...
        map.put(127, new CeloContext());
        map.put(128, new EtcContext());
        map.put(129, new BaseChainContext());
        return map;
    }
    ...
    /**
     注册跨链网络
     主网:
     registerheterogeneousmainasset NERVEepb69uqMbNRufoPz6QGerCMtDG4ybizAA 127
     registerheterogeneousmainasset NERVEepb69uqMbNRufoPz6QGerCMtDG4ybizAA 128
     registerheterogeneousmainasset NERVEepb69uqMbNRufoPz6QGerCMtDG4ybizAA 129
     */
