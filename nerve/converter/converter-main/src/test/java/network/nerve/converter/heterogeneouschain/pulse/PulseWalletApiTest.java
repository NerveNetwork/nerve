package network.nerve.converter.heterogeneouschain.pulse;
...
public class PulseWalletApiTest extends Base {

    String testEthRpcAddress = "https://rpc.v4.testnet.pulsechain.com";
    int testChainId = 943;
    String mainEthRpcAddress = "https://rpc.pulsechain.com";
    int mainChainId = 369;
    @Override
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_PULSE;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_PULSE;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_PULSE_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void before() {
        try {
            String path = new File(PulseWalletApiTest.class.getClassLoader().getResource("").getFile()).getParentFile().getParentFile().getParentFile().getParentFile().getParentFile().getPath();
