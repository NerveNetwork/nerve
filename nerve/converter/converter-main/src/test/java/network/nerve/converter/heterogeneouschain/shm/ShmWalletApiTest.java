...
public class ShmWalletApiTest extends Base {
    ...
    public void registerERC20Minter() throws Exception {
        ...
        String erc20Minter = "0xa00de023329752c64f3f5fd82d6b655dcfbfe41f";
    ...
    public void isMinterERC20Test() throws Exception {
        String contractAddress = "0x5e7E2AbAa58e108f5B9D5D30A76253Fa8Cb81f9d";
        List<Type> result = htgWalletApi.callViewFunction(contractAddress, HtgUtil.getIsMinterERC20Function("0xa00de023329752c64f3f5fd82d6b655dcfbfe41f"));
        if (result.isEmpty()) {
            return;
        }
