package network.nerve.converter.heterogeneouschain.kroma;
...
public class KromaWalletApiTest extends Base {

    String testEthRpcAddress = "https://api.sepolia.kroma.network";
    int testChainId = 2358;
    String mainEthRpcAddress = "https://api.kroma.network";
    int mainChainId = 255;
    @Override
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_KROMA;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_KROMA;
        erc20Decimals = 18;
    }
    ...
    public void before() {
        try {
            String path = new File(KromaWalletApiTest.class.getClassLoader().getResource("").getFile()).getParentFile().getParentFile().getParentFile().getParentFile().getParentFile().getPath();
    ...
    protected void setLocalNewTest() {
        ...
        this.multySignContractAddress = "0xF2e1C076eede6F0B8d82eE78fa12112DDEfb5f06";
        init();
    }
