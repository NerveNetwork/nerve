package network.nerve.converter.heterogeneouschain.eos.core;
...
import network.nerve.converter.heterogeneouschain.eos.base.Base;
...
public class EosWalletApiTest extends Base {
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_EOS;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_EOS;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_EOS_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void before() {
        try {
            String path = new File(EosWalletApiTest.class.getClassLoader().getResource("").getFile()).getParentFile().getParentFile().getParentFile().getParentFile().getParentFile().getPath();
    ...
    public void getBalance() throws Exception {
        setLocalTest();
        setAccount_EFa1();
        erc20BalancePrint("NVT", from, NVT_EOS_MINTER, 8);
        erc20BalancePrint("USDT", from, USDT_EOS, 6);
