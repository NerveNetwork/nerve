package network.nerve.converter.heterogeneouschain.celo.core;
...
import network.nerve.converter.heterogeneouschain.celo.base.Base;
...
public class CeloWalletApiTest extends Base {
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_CELO;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_CELO;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_CELO_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void before() {
        try {
            String path = new File(CeloWalletApiTest.class.getClassLoader().getResource("").getFile()).getParentFile().getParentFile().getParentFile().getParentFile().getParentFile().getPath();
    ...
    public void transferBatch() throws Exception {
        ...
        BigInteger gasPrice = new BigDecimal("52.5").movePointRight(9).toBigInteger();
        ...
        for (int i = 3; i < 100; i++) {
            ...
            System.out.println(String.format("Transfer to %s %s CELO, transactionhash: %s", to, sendAmount, txHash));
    ...
    public void getBalance() throws Exception {
        setLocalTest();
        setAccount_EFa1();
        erc20BalancePrint("NVT", from, NVT_CELO_MINTER, 8);
        erc20BalancePrint("USDT", from, USDT_CELO, 6);
    ...
    public void sendMainAssetWithdrawBySignDataTest() throws Exception {
        ...
        setMainProxy();
        htgContext.setEthGasPrice(htgWalletApi.getCurrentGasPrice());
        String txKey = "920dd549a37b91ead0216860ab08eaa4caa4503a5d2217ed25f70de781146fa0";
        // Recipient Address
        String toAddress = "0x9bdbdb4a8f7f816c87a67f5281484ed902c6b942";
        // quantity
        String value = "0.052432767598544844";
        String signData = "";
