package network.nerve.converter.heterogeneouschain.manta.core;
...
import network.nerve.converter.heterogeneouschain.manta.base.Base;
...
public class MantaWalletApiTest extends Base {
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_MANTA;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_MANTA;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_MANTA_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void before() {
        try {
            String path = new File(MantaWalletApiTest.class.getClassLoader().getResource("").getFile()).getParentFile().getParentFile().getParentFile().getParentFile().getParentFile().getPath();
    ...
    public void getBalance() throws Exception {
        setLocalTest();
        setAccount_EFa1();
        erc20BalancePrint("NVT", from, NVT_MANTA_MINTER, 8);
        erc20BalancePrint("USDT", from, USDT_MANTA, 6);
    ...
    public void getTx() throws Exception {
        //setMain();
        // Directly callingerc20contract
        String directTxHash = "0xbe2e16ed6d92dadcb8d8a3a1c2b6c8addd87f47b01368635c76b284bf1c875e3";
        Transaction tx = htgWalletApi.getTransactionByHash(directTxHash);
        System.out.println(JSONUtils.obj2PrettyJson(tx));
    }
