package network.nerve.converter.heterogeneouschain.janus.core;
...
import network.nerve.converter.heterogeneouschain.janus.base.Base;
...
public class JanusWalletApiTest extends Base {
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_JANUS;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_JANUS;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_JANUS_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void before() {
        try {
            String path = new File(JanusWalletApiTest.class.getClassLoader().getResource("").getFile()).getParentFile().getParentFile().getParentFile().getParentFile().getParentFile().getPath();
    ...
    public void depositERC20ByCrossOut() throws Exception {
        ...
        //String sendAmount = "1.123456";
        //String sendAmount = "1234.123456789123456789";
        String sendAmount = "20.12345678";
    ...
    public void getBalance() throws Exception {
        setLocalTest();
        setAccount_EFa1();
        erc20BalancePrint("NVT", from, NVT_JANUS_MINTER, 8);
        erc20BalancePrint("USDT", from, USDT_JANUS, 6);
