...
public class HtWalletApiTest extends Base {
    ...
    protected void setErc20HUSD() {
        erc20Address = HUSD_HT_18;
        erc20Decimals = 18;
    }
    ...
    protected void setLocalTest() {
        ...
        // used: 0x8B3b22C252F431a75644E544FCAf67E390A206F4
        init();
    }
    protected void setBeta() {
        // ["0x1a9f8b818a73b0f9fde200cd88c42b626d2661cd","0x6c2039b5fdae068bad4931e8cc0b8e3a542937ac","0x3c2ff003ff996836d39601ca22394a58ca9c473b"]
        list = new ArrayList<>();
    ...
    public void transferHTAndERC20() throws Exception {
        ...
        System.out.println(String.format("towards[%s]Transfer%sindividualHT, transactionhash: %s", multySignContractAddress, sendAmount, txHash));
        // ERC20
    ...
    @Test
    public void transferHT() throws Exception {
        setLocalTest();
        BigInteger gasPrice = htgContext.getEthGasPrice();
        // initialization account
        setAccount_EFa1();
        String to = this.multySignContractAddress;
        // HTquantity
        String sendAmount = "0.1";
        String txHash = htgWalletApi.sendMainAssetForTestCase(from, fromPriKey, to, new BigDecimal(sendAmount), BigInteger.valueOf(81000L), gasPrice);
        System.out.println(String.format("towards[%s]Transfer%sindividualHT, transactionhash: %s", to, sendAmount, txHash));
    }
        /**
    ...
    public void depositHTByCrossOut() throws Exception {
        ...
        System.out.println(String.format("htRecharge[%s], hash: %s", sendAmount, hash));
    }
    ...
    public void ethWithdrawBy15Managers() throws Exception {
        ...
        System.out.println(String.format("HTWithdrawal%sPieces,%sSignatures,hash: %s", value, signCount, hash));
    }
    ...
    public void getTransaction() throws Exception {
        //setMain();
        String directTxHash = "0xb7aee0ff62b89b0dea8bcc291936b8d80e4d9c4f0111afec60f629ef86ddcf71";
    ...
    public void newParseWithdrawTxReceiptTest() throws Exception {
        ...
        list.add("0xb9d192fd11d822d7bd8ce7cedb91c2ee1dc6b64b3db6efe21cbe090ce37f704e");
        list.add("0x139bc8245e330e97f4753bb36d2250f7c925778517348f5da2acbfdf682d66d8");
        list.add("0xcc92c97fbe3b47762787c7f37e5aae7b783dab31dc21dcc97a4721576091d49c");
        list.add("0x3397705b7b5207dd1e9e80ecb75172c42706349ec1c5b09cd3df6cdb01b76d5e");
        list.add("0xafe27c329739b088e977ab184c2a567a98c9022b6dc85311b82ba9ea814a83a5");
        list.add("0xd648bb94070fe3c64638167bfb1c616e432883c6b401d141b79df4a8d4e6ea43");
        list.add("0xa54d0a0325059771f97bda91ae76f5432c554a8f40405396a1d257fe43b23478");
        list.add("0x24543ab15507293068963ce008d07eb0de79ccb90450c0a1427700db24ed71c9");
        list.add("0x1506547e1af34593188512e1ffff571784f704655401e52afd19141e8ddb5667");
        list.add("0xae544043f7cdd13be12e22994b462402f22b36bde3a1abf0a681032456b74bf0");
