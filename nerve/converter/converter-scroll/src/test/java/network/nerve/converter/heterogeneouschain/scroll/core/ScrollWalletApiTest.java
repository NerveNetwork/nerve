package network.nerve.converter.heterogeneouschain.scroll.core;
...
import network.nerve.converter.heterogeneouschain.scroll.base.Base;
...
public class ScrollWalletApiTest extends Base {
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_SCROLL;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_SCROLL;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_SCROLL_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void before() {
        try {
            String path = new File(ScrollWalletApiTest.class.getClassLoader().getResource("").getFile()).getParentFile().getParentFile().getParentFile().getParentFile().getParentFile().getPath();
    ...
    public void transferERC20() throws Exception {
        ...
        if (token.hasError()) {
            System.err.println(String.format("【fail】towards[%s]Transfer%sindividualERC20(USDT), transactionhash: %s", to, tokenAmount, token.getError().getMessage()));
        } else {
        ...
        if (token.hasError()) {
            System.err.println(String.format("【fail】towards[%s]Transfer%sindividualERC20(USD18), transactionhash: %s", to, tokenAmount, token.getError().getMessage()));
        } else {
    ...
    public void getBalance() throws Exception {
        setLocalTest();
        setAccount_EFa1();
        erc20BalancePrint("NVT", from, NVT_SCROLL_MINTER, 8);
        erc20BalancePrint("USDT", from, USDT_SCROLL, 6);
    ...
    public void getTx() throws Exception {
        setMain();
        // Directly callingerc20contract
        String directTxHash = "0x7ecd72e9a52576fe1fd28aa0a79eb47b11b39f3821192cfb045edaa647c509c9";
        Transaction tx = htgWalletApi.getTransactionByHash(directTxHash);
        System.out.println(JSONUtils.obj2PrettyJson(tx));
    }
    ...
    public void txL1GasUsedTest() throws Exception {
        ...
        //list.add("0x7ecd72e9a52576fe1fd28aa0a79eb47b11b39f3821192cfb045edaa647c509c9");
        //list.add("0xde96aa7b1c0fad723aeb3e5c9f9d65123023cfae95e371a681c9b5fac8a2afc8");
        //list.add("0x4d167682e376fe29afbb7ecff155cd4239f3116e1a8ea70a680f8d67bc0eb4ed");
        //list.add("0xc128742441c8fb08878f547ac90e08ef8c8b47290cccae29a05e846dd4c59f85");
        //list.add("0x8b6e8ad7a23fee8c653476f2be5c26dd1799f2e14847d1766a25177bc9229009");
        //list.add("0xfe943a74023afc67ce23ce054e70d3b7ec7688b12426b04b24720001b6aca7ed");
        //list.add("0xeb9d766c162b54d5a4aa826604bf9f2bf01690a203bce224f067ec44d68ad650");
        list.add("0x88ec5219c8b676c140296fedc9727583cf3f2a8c9a04aac457fa8202a09a0c6a");
    ...
    private void getL1GasUsedOnScroll(Transaction tx) {
        ...
        int result = _total + 2500 + (4 * 16);
        System.out.println(result);
        result += 3000;
        BigInteger realFee = getL1FeeOnScroll(BigInteger.valueOf(result), BigInteger.valueOf(40000000000L));
        System.out.println(realFee);
        System.out.println(new BigDecimal(realFee).movePointLeft(18).toPlainString());
        /**
         *  Optimism & Base & Kroma
         */
        //int result = _total + 188;
        //System.out.println(result);
    }

    BigInteger _l1GasUsedOnScroll = BigInteger.valueOf(21000L);
    BigInteger _l1GasUsedOnOptimismOrBase = BigInteger.valueOf(18000L);
    BigInteger _l1GasUsedOnManta = BigInteger.valueOf(18000L);
    BigInteger scalarOnScroll = BigInteger.valueOf(1150000000L);
    BigInteger precisionOnScroll = BigInteger.valueOf(1000000000L);
    BigDecimal dynamicOverheadOnOptimismOrBase = new BigDecimal("0.684");
    BigDecimal dynamicOverheadOnManta = new BigDecimal("1");

    public BigInteger getL1FeeOnScroll(BigInteger _l1GasUsed, BigInteger ethNetworkGasPrice) {
        return _l1GasUsed.multiply(ethNetworkGasPrice).multiply(scalarOnScroll).divide(precisionOnScroll);
    }

    public BigInteger getL1FeeOnOptimismOrBase(BigInteger _l1GasUsed, BigInteger ethNetworkGasPrice) {
    ...
    //TODO pierre look formanta L1 feeCalculation method
    public BigInteger getL1FeeOnManta(BigInteger _l1GasUsed, BigInteger ethNetworkGasPrice) {
        return new BigDecimal(_l1GasUsed).multiply(dynamicOverheadOnManta).multiply(new BigDecimal(ethNetworkGasPrice)).toBigInteger();
    }

    @Test
    public void getL1FeeOnOptimismTest() {
        BigInteger fee = getL1FeeOnOptimismOrBase(_l1GasUsedOnOptimismOrBase, new BigDecimal("73.811768103").movePointRight(9).toBigInteger());
        System.out.println(fee);
        System.out.println(new BigDecimal(fee).movePointLeft(18).toPlainString());
    }
