package network.nerve.converter.heterogeneouschain.zk.core;
...
import network.nerve.converter.heterogeneouschain.zk.base.Base;
...
public class ZkWalletApiTest extends Base {
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_ZK;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_ZK;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_ZK_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void depositERC20ByCrossOut() throws Exception {
        ...
        String sendAmount = "5.12345678";// 1.123456, 1234.123456789123456789
    ...
    public void getBalance() throws Exception {
        setLocalTest();
        setAccount_EFa1();
        erc20BalancePrint("NVT", from, NVT_ZK_MINTER, 8);
        erc20BalancePrint("USDT", from, USDT_ZK, 6);
