package network.nerve.converter.heterogeneouschain.basechain.core;
...
import network.nerve.converter.heterogeneouschain.basechain.base.Base;
...
public class BaseChainWalletApiTest extends Base {
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_BASECHAIN;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_BASECHAIN;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_BASECHAIN_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void before() {
        try {
            String path = new File(BaseChainWalletApiTest.class.getClassLoader().getResource("").getFile()).getParentFile().getParentFile().getParentFile().getParentFile().getParentFile().getPath();
    ...
    protected void setLocalNewTest() {
        ...
        init();
        htgContext.setEthGasPrice(GWEI_1);
    }
    ...
    public void getBalance() throws Exception {
        setLocalTest();
        setAccount_EFa1();
        erc20BalancePrint("NVT", from, NVT_BASECHAIN_MINTER, 8);
        erc20BalancePrint("USDT", from, USDT_BASECHAIN, 6);
