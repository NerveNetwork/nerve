package network.nerve.converter.heterogeneouschain.one.core;
...
import network.nerve.converter.heterogeneouschain.one.base.Base;
...
public class OneWalletApiTest extends Base {
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_ONE;
        erc20Decimals = 6;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_ONE_MINTER;
        erc20Decimals = 8;
    }
    protected void setErc20NULS() {
        erc20Address = NULS_ONE_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void getBalance() throws Exception {
        setLocalTest();
        setAccount_EFa1();
        erc20BalancePrint("NVT", from, NVT_ONE_MINTER, 8);
        erc20BalancePrint("USDT", from, USDT_ONE, 6);
    ...
    @Test
    public void test1() {
        String a = "NULSd6HgWUewpeSCLLvDZjd2eMZRzroCfMygg";
        System.out.println(AddressTool.validAddress(1, a));
    }
    ...
    protected void setMainData() {
        ...
        list.add("");
        list.add("");
        this.multySignContractAddress = "0x32fae32961474e6d19b7a6346524b8a6a6fd1d9c";
        init();
    }
    ...
    public void signDataForERC20WithdrawTest() throws Exception {
         ...
         */
        setMainData();
        String txKey = "ddd1024102410240000000000000000000000000000000000000000000000000";
        // 接收者地址
        String toAddress = "0x0Eb9e4427a0Af1Fa457230bEF3481d028488363E";
        // 转出数量
        String value = "2099.891468";
        // token合约
        String erc20 = "0x3C2B8Be99c50593081EAA2A724F0B8285F5aba8f";
        int tokenDecimals = 6;
        int signCount = 5;
    ...
    public void txInputWithdrawDecoderTest() throws JsonProcessingException {
        String input = "0xa9059cbb000000000000000000000000c11d9943805e56b630a401d4bd9a29550353efa100000000000000000000000000000000000000000000000000000000001e8480";
    ...
    public void getCurrentNonce() throws Exception {
        setMain();
        BigInteger nonce = htgWalletApi.getNonce("0xd87F2ad3EF011817319FD25454FC186CA71B3B56");
        System.out.println(nonce);
        nonce = htgWalletApi.getLatestNonce("0xd87F2ad3EF011817319FD25454FC186CA71B3B56");
        System.out.println(nonce);
    }
