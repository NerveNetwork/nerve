package network.nerve.converter.heterogeneouschain.goerlieth.core;
...
import network.nerve.converter.heterogeneouschain.goerlieth.base.Base;
...
public class GoerliWalletApiTest extends Base {
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_GOERLI;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_GOERLI;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_GOERLI_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void depositERC20ByCrossOut() throws Exception {
        ...
        String sendAmount = "12";// 1.123456, 1234.123456789123456789
    ...
    public void getBalance() throws Exception {
        setLocalTest();
        setAccount_EFa1();
        erc20BalancePrint("NVT", from, NVT_GOERLI_MINTER, 8);
        erc20BalancePrint("USDT", from, USDT_GOERLI, 6);
