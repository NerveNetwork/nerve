package network.nerve.converter.heterogeneouschain.metis.core;
...
import network.nerve.converter.heterogeneouschain.metis.base.Base;
...
public class MetisWalletApiTest extends Base {
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_METIS;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_METIS;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_METIS_MINTER;
        erc20Decimals = 8;
    }
    ...
    protected void setBeta() {
        ...
        this.multySignContractAddress = "0x03Cf96223BD413eb7777AFE3cdb689e7E851CB32";
        init();
    }
    ...
    public void erc20TotalSupplyTest() throws Exception {
        //setMain();
        setErc20USDT();
        BigInteger totalSupply = this.erc20TotalSupply(erc20Address);
    ...
    @Test
    public void transferMainAssetLoop() throws Exception {
        setLocalTest();
        htgContext.setEthGasPrice(htgWalletApi.getCurrentGasPrice());
        BigInteger gasPrice = htgContext.getEthGasPrice();
        // initialization account
        ...
        for (int i = 0; i < 1000; i++) {
            String txHash = htgWalletApi.sendMainAssetForTestCase(from, fromPriKey, from, new BigDecimal(sendAmount), BigInteger.valueOf(21000), gasPrice);
            System.out.println(String.format("towards[%s]Transfer%sindividualMainAsset, transactionhash: %s", from, sendAmount, txHash));
    ...
    public void getBalance() throws Exception {
        setLocalTest();
        setAccount_EFa1();
        erc20BalancePrint("NVT", from, NVT_METIS_MINTER, 8);
        erc20BalancePrint("USDT", from, USDT_METIS, 6);
