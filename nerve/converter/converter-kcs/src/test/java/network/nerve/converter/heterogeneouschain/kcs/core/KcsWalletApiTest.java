package network.nerve.converter.heterogeneouschain.kcs.core;
...
public class KcsWalletApiTest extends Base {
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_KCS;
        erc20Decimals = 6;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_KCS_MINTER;
        erc20Decimals = 8;
    }
    protected void setErc20NULS() {
        erc20Address = NULS_KCS_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void getBalance() throws Exception {
        setLocalTest();
        setAccount_EFa1();
        erc20BalancePrint("NVT", from, NVT_KCS_MINTER, 8);
        erc20BalancePrint("USDT", from, USDT_KCS, 6);
