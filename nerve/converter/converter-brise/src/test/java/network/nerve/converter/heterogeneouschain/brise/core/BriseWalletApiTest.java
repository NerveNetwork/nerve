package network.nerve.converter.heterogeneouschain.brise.core;
...
import network.nerve.converter.heterogeneouschain.brise.base.Base;
...
public class BriseWalletApiTest extends Base {
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_BRISE;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_BRISE;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_BRISE_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void before() {
        try {
            String path = new File(BriseWalletApiTest.class.getClassLoader().getResource("").getFile()).getParentFile().getParentFile().getParentFile().getParentFile().getParentFile().getPath();
    ...
    public void depositERC20ByCrossOut() throws Exception {
        ...
        String sendAmount = "2.12345678";// 1.123456, 1234.123456789123456789
    ...
    public void getBalance() throws Exception {
        setLocalTest();
        setAccount_EFa1();
        erc20BalancePrint("NVT", from, NVT_BRISE_MINTER, 8);
        erc20BalancePrint("USDT", from, USDT_BRISE, 6);
