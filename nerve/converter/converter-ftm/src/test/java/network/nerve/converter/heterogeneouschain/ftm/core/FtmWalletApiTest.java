package network.nerve.converter.heterogeneouschain.ftm.core;
...
import network.nerve.converter.heterogeneouschain.ftm.base.Base;
...
public class FtmWalletApiTest extends Base {
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_FTM;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_FTM;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_FTM_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void getBalance() throws Exception {
        setLocalTest();
        setAccount_EFa1();
        erc20BalancePrint("NVT", from, NVT_FTM_MINTER, 8);
        erc20BalancePrint("USDT", from, USDT_FTM, 6);
