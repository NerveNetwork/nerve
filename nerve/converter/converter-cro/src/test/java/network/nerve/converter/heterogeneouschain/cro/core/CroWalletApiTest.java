package network.nerve.converter.heterogeneouschain.cro.core;
...
import network.nerve.converter.heterogeneouschain.cro.base.Base;
...
public class CroWalletApiTest extends Base {
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_CRO;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_CRO;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_CRO_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void depositMainAssetByCrossOut() throws Exception {
        setLocalTest();
        this.multySignContractAddress = "0xb6D685346106B697E6b2BbA09bc343caFC930cA3";
        htgContext.setEthGasPrice(new BigDecimal("5000").scaleByPowerOfTen(9).toBigInteger());
        // 初始化 账户
        setAccount_EFa1();
        // MainAsset数量
        String sendAmount = "2";
    ...
    public void getBalance() throws Exception {
        setLocalTest();
        setAccount_EFa1();
        erc20BalancePrint("NVT", from, NVT_CRO_MINTER, 8);
        erc20BalancePrint("USDT", from, USDT_CRO, 6);
    ...
    public void getTxReceipt() throws Exception {
        ...
        System.out.println(txReceipt.isStatusOK());
    }
