package network.nerve.converter.heterogeneouschain.iotx.core;
...
import network.nerve.converter.heterogeneouschain.iotx.base.Base;
...
public class IotxWalletApiTest extends Base {
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_IOTX;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_IOTX;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_IOTX_MINTER;
        erc20Decimals = 8;
    }
    ...
    protected void setBeta() {
        ...
        this.multySignContractAddress = "0x3F1f3D17619E916C4F04707BA57d8E0b9e994fB0";
        init();
    }
    ...
    public void getBalance() throws Exception {
        setLocalTest();
        setAccount_EFa1();
        erc20BalancePrint("NVT", from, NVT_IOTX_MINTER, 8);
        erc20BalancePrint("USDT", from, USDT_IOTX, 6);
    ...
    public void getTxReceipt() throws Exception {
        String directTxHash = "0x3b2e84eeb792c56588bf0450e3219cb3f5fd4325b94a47ab63348bc97cdcbf69";
