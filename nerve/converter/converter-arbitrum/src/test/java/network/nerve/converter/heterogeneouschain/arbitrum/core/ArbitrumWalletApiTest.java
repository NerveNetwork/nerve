package network.nerve.converter.heterogeneouschain.arbitrum.core;
...
import network.nerve.converter.heterogeneouschain.arbitrum.base.Base;
...
public class ArbitrumWalletApiTest extends Base {
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_ARBI;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_ARBI;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_ARBI_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void depositERC20ByCrossOut() throws Exception {
        ...
        setAccount_EFa1();
        // ERC20 转账数量
        String sendAmount = "43211234.123456789123456789";
        // 初始化 ERC20 地址信息
        //setErc20USDT();
        //setErc20NVT();
        setErc20USD18();
    ...
    public void getBalance() throws Exception {
        setLocalTest();
        setAccount_EFa1();
        erc20BalancePrint("NVT", from, NVT_ARBI_MINTER, 8);
        erc20BalancePrint("USDT", from, USDT_ARBI, 6);
