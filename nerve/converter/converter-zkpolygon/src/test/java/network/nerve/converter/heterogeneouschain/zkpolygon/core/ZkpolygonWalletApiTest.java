package network.nerve.converter.heterogeneouschain.zkpolygon.core;
...
import network.nerve.converter.heterogeneouschain.zkpolygon.base.Base;
...
public class ZkpolygonWalletApiTest extends Base {
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_ZKP;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_ZKP;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_ZKP_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void before() {
        try {
            String path = new File(ZkpolygonWalletApiTest.class.getClassLoader().getResource("").getFile()).getParentFile().getParentFile().getParentFile().getParentFile().getParentFile().getPath();
    ...
    public void getBalance() throws Exception {
        setLocalTest();
        setAccount_EFa1();
        erc20BalancePrint("NVT", from, NVT_ZKP_MINTER, 8);
        erc20BalancePrint("USDT", from, USDT_ZKP, 6);
