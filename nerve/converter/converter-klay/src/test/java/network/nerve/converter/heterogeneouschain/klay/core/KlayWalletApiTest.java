package network.nerve.converter.heterogeneouschain.klay.core;
...
import network.nerve.converter.heterogeneouschain.klay.base.Base;
...
public class KlayWalletApiTest extends Base {
    ...
    protected void setErc20USDT() {
        erc20Address = USDT_KLAY;
        erc20Decimals = 6;
    }
    protected void setErc20USD18() {
        erc20Address = USD18_KLAY;
        erc20Decimals = 18;
    }
    protected void setErc20NVT() {
        erc20Address = NVT_KLAY_MINTER;
        erc20Decimals = 8;
    }
    ...
    public void getBalance() throws Exception {
        setLocalTest();
        setAccount_EFa1();
        erc20BalancePrint("NVT", from, NVT_KLAY_MINTER, 8);
        erc20BalancePrint("USDT", from, USDT_KLAY, 6);
