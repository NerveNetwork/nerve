...
import network.nerve.quotation.heterogeneouschain.constant.BnbConstant;
...
import static network.nerve.quotation.heterogeneouschain.constant.BnbConstant.ZERO_ADDRESS;
import static network.nerve.quotation.heterogeneouschain.context.BnbContext.*;
...
public class BNBWalletApi implements WalletApi {
    ...
    public String sendBNB(String fromAddress, String privateKey, String toAddress, BigDecimal value, BigInteger gasLimit, BigInteger gasPrice) throws Exception {
        ...
        if (bnbBalance == null) {
            throw new RuntimeException("Get the current addressBNBBalance failed");
        }
    ...
    public String sendTransaction(String toAddress, String fromAddress, String secretKey, BigDecimal amount) {
        ...
        try {
            result = sendBNB(fromAddress, secretKey, toAddress, amount, BNB_GAS_LIMIT_OF_BNB, BnbContext.getBscGasPrice());
        } catch (Exception e) {
    ...
    public EthSendTransaction sendTransaction(String toAddress, String fromAddress, String secretKey, BigDecimal amount, String contractAddress) throws Exception {
        ...
        EthSendTransaction result = transferERC20Token(
                ...
                secretKey,
                contractAddress,
                BnbContext.getBscGasPrice(),
                BNB_GAS_LIMIT_OF_BEP20);
        return result;
    }
    ...
    private Function getCrossOutFunction(String toAddress, BigInteger value, String erc20) {
        ...
        return new Function(BnbConstant.METHOD_CROSS_OUT, inputParameters, outputParameters);
    }
    ...
    private EthSendTransactionPo callContract(String from, String privateKey, String contractAddress, BigInteger gasLimit, Function function, BigInteger value, BigInteger gasPrice) throws Exception {
        ...
        gasPrice = gasPrice == null || gasPrice.compareTo(BigInteger.ZERO) == 0 ? BnbContext.getBscGasPrice() : gasPrice;
        String encodedFunction = FunctionEncoder.encode(function);
        List argsList = new ArrayList();
        argsList.add(from);
