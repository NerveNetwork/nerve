package network.nerve.quotation.rpc.callback;
...
public class NewBlockHeightInvoke extends BaseInvoke {
    ...
    public void callBack(Response response) {
        ...
        LoggerUtil.LOG.debug("[Subscription events]Latest block height:{} blockTime:{} syncStatus:{}", height, time, syncStatusEnum.name());
