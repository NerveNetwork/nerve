...
public class TxRegisterDetail {
    ...
    @ApiModelProperty(description = "Do I need to call the packaging processor for this type of transaction during packaging")
    private boolean packProduce;

    @ApiModelProperty(description = "Transactions generated during block assembly transactions")
